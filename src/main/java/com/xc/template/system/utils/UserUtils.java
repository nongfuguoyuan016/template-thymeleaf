...
import com.xc.template.system.dao.*;
import com.xc.template.system.entity.*;
...
public class UserUtils {
	 ...
	 * @return
	 */
	public static String getUserId(){return getUser().getId();};
	 ...
	 * @return
	 */
	public static String getUserLoginNameById(String id){
	...
	public static boolean hasSubMenu(String parentMenuId){
		List<Menu> menuList = getMenuList() ;
		Optional<Menu> any = menuList.stream().filter(menu -> menu.getParentId().equals(parentMenuId) && "1".equals(menu.getIsShow())).findAny();
