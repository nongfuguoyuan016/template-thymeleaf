...
public class OfficeController extends BaseController {
	...
	@ResponseBody
	public JSONResult save(@Valid Office office, Model model, RedirectAttributes redirectAttributes) {
	...
	@ResponseBody
	public JSONResult delete(Office office, RedirectAttributes redirectAttributes) {
		officeService.delete(office);
		return JSONResult.ok("删除机构成功");
	}
