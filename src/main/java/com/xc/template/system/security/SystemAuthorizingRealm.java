...
package com.xc.template.system.security;
...
import com.xc.template.common.web.Servlets;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		if (sessions.size() > 0 && !UserUtils.getSubject().isAuthenticated()){
		...
		if (user != null) {
			...
			// 记录登录日志
			logService.saveLog(Servlets.getRequest(),null, null, "系统登录");
			return info;
		} else {
			return null;
		}
